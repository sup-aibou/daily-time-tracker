	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Vehicle Category and Parking Price Management</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Vehicle Categories </div>
        ...
        <tbody>
        <?php
        $ret=mysqli_query($con,"SELECT * from  parkingprice");
        $cnt=1;
