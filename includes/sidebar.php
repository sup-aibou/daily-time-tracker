<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar h-100 overflow-hidden">
	...
	<ul class="nav menu">
		...
		<!-- <?php if ($row['UserType'] == 1): ?>
			...
			<li class="<?php if ($page == "add-reservation") {
							echo "active";
						} ?>"><a href="add-reservation.php"><em class="fa fa-check-square-o">&nbsp;</em> Parking Reservation</a></li>
			<li class="<?php if ($page == "saved-user") {
							echo "active";
						} ?>"><a href="saved-user.php"><em class="fa fa-user-circle-o">&nbsp;</em> Saved User</a></li>
			<li class="<?php if ($page == "user-balance") {
							echo "active";
						} ?>"><a href="user-balance.php"><em class="fa fa-btc">&nbsp;</em> User Balance</a></li>
			<li class="<?php if ($page == "payment-history") {
							echo "active";
						} ?>"><a href="payment-history.php"><em class="fa fa-btc">&nbsp;</em> Payment History</a></li>
			<li class="<?php if ($page == "vehicle-category") {
							echo "active";
						} ?>"><a href="vehicle-category.php"><em class="fa fa-money">&nbsp;</em> Parking Price</a></li>
			<li class="<?php if ($page == "reports") {
							echo "active";
						} ?>"><a href="reports.php"><em class="fa fa-file">&nbsp;</em> View Reports</a></li>
			<li class="<?php if ($page == "income") {
							echo "active";
						} ?>"><a href="total-income.php"><em class="fa fa-rouble">&nbsp;</em> Total Income</a></li>
			<li class="<?php if ($page == "admin-list") {
							echo "active";
