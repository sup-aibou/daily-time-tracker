...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Parking Slots Management</li>
			</ol>
		</div><!--/.row-->
        ...
        <tbody>
        <?php
        $ret=mysqli_query($con,"SELECT * from  parkingslot");
        $cnt=1;
   ...
   <td>
    ...
    ?>
			...
			<td><a href="update-slot.php?updateid=<?php echo $row['ID'];?>"><button type="button" class="btn btn-sm btn-info">Action</button></a>
            </td>
