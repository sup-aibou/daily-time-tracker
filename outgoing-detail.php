		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Outgoing Vehicles Details</div>
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php  echo $row['VehicleModel'];?>" id="sdesc" name="sdesc" readonly>
								</div>

								<div class="form-group">
									<label>Vehicle Color</label>
									<input type="text" class="form-control" value="<?php  echo $row['VehicleColor'];?>" id="sdesc" name="sdesc" readonly>
								</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php  echo $row['DriversLicensed'];?>" id="sdesc" name="sdesc" readonly>
								</div>
